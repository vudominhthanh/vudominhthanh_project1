...
return new class extends Migration
{
    ...
    {
        Schema::create('vdmtcustomer', function (Blueprint $table) {
            $table->id();
            $table->string('vdmtcusid',255)->unique();
            $table->string('vdmtcusname',255);
            $table->string('vdmtcusemail',255)->unique();
            $table->string('vdmtcuspassword',255);
            $table->string('vdmtcusnumber',255)->unique();
    ...
    {
        Schema::dropIfExists('vdmtcustomer');
    }
};
