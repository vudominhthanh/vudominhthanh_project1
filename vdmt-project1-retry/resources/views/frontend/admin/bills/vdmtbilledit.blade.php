...
@push('styles')
    ...
    <style>
        ...
        form input[type="text"], form input[type="email"], form input[type="number"], form input[type="radio"] {
            width: calc(100% - 10px);
            padding: 8px;
        ...
        form input[type="text"]:focus, form input[type="email"]:focus, form input[type="number"]:focus, form input[type="radio"]:focus {
            border-color: #007bff;
...
<input type="hidden" name="id" id="id"  value="{{$vdmtbills->id}}">
    ...
    <div>
        <label for="vdmtcusid"><i class="fas fa-id-badge icon"></i>Cus Id</label>
